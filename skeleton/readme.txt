one shiftonefdsfsdfMUSHclientx64 version 5.08 x64 Nodens
=======================
NOTICE: Do NOT install under "C:\Program Files" unless you plan to run as administrator. Which is highly NOT suggested. Eventually installion under Program Files will be supported.
...
*Relaxed telnet option negotiation RFC when it comes to responding to attempts at renegotiation as it breaks Diku derivatives using "copyover" and trying to renegotiate telnet options once the new binary executes. (This will eventually be a toggleable option).
*Included Luasocket 3.1.0 so users do not have to recompile it to x64.

Author: Panagiotis Kalogiratos (Nodens)

Contact/support:
Obviously on CthulhuMUD:
CthulhuMUD MUD: cthulhumud.com:8889
CthulhuMUD Web: www.cthulhumud.com

The fresh CthulhuMUD discord: https://discord.gg/62Px9EHjt6
Or /r/MUD subreddit's discord as well: https://discord.gg/multi-user-dungeon-279748146316312576

You can always find the latest build here: https://mushclient.cthulhumud.com
And eventually also in the public github repository that will go up later on will be listed here in this file as well.

------------------------------------------
Original MUSHclient infromation:
